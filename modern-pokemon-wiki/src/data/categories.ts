...
export const categories: WikiCategory[] = [
  {
    id: "kanto",
    title: "Kanto",
    description: "Explore the classic Kanto region features",
    icon: "star",
    href: "/wiki/kanto",
    subcategories: [
      {
      ...
      },
      {
        ...
        keywords: "raids Grass Fire Water Normal Rock Steel Fighting Bug Ground Ghost Dark Ice Poison Psychic Flying Fairy Electric Dragon",
        href: "/wiki/raids",
        icon: "sword"
      }
    ],
  },
  {
    id: "johto",
    title: "Johto",
    description: "Discover Johto region adventures",
    icon: "map",
    href: "/wiki/johto",
    subcategories: [
      {
  ...
  },
  {
    id: "hoenn",
    title: "Hoenn",
    description: "Master Hoenn region challenges",
    icon: "trophy",
    href: "/wiki/hoenn",
    subcategories: [
      {
  ...
  },
  {
    id: "sinnoh",
    title: "Sinnoh",
    description: "Coming soon to Sinnoh region",
    icon: "gamepad-2",
    href: "/wiki/sinnoh",
    subcategories: [
      {
  ...
  },
  {
    ...
    description: "Essential Pokémon Center services",
    icon: "building-2",
    href: "/wiki/pokemon-center",
    subcategories: [
      {
        name: "Quests",
